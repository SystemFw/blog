...
In the end, our whole program will represented by a single expression,
...
// nothing gets printed, but we explicitly describe printing one word
// after another as another value of type Console
